...
def getSentenceFeature(tokens, wordVectors, sentence):
    ...
    ### YOUR CODE HERE
    indexes = [tokens[word] for word in sentence]
...
def softmaxRegression(features, labels, weights, regularization = 0.0, nopredictions = False):
    ...
    # Inputs:                                                         
    # - features: feature vectors, each row is a feature vector - N x D
    # - labels: labels corresponding to the feature vectors - N
    # - weights: weights of the regressor - D x C
    # - regularization: L2 regularization constant - scalar
    ...
    prob = softmax(features.dot(weights)) # N x C
    ...
    scores = prob - y
    grad = ((1.0 / N) * features.T.dot(scores)) + (regularization * weights)
